...
@Controller
public class RecruitmentquotasApiController implements RecruitmentquotasApi {

    public ResponseEntity<RecruitmentQuotaRes> recruitmentquotasCreatePost(
...
@ApiParam(value = "Details for the new recruitment quota ." ,required=true ) @RequestBody RecruitmentQuotaReq recruitmentQuota
    ...
    public ResponseEntity<RecruitmentQuotaRes> recruitmentquotasSearchPost(
